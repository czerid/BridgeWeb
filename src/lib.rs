...
#[derive(Debug)]
pub struct BridgeWeb3Processor {
    verbose: bool,
    processed_count: usize,
}

impl BridgeWeb3Processor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting BridgeWeb3 processing");
    
    let mut processor = BridgeWeb3Processor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = BridgeWeb3Processor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = BridgeWeb3Processor::new(false);
